...
from networks.tnet.util import *
from networks.tnet.resnet_mp import *
...
class AimNet(nn.Module):
    ...
    def __init__(self, pretrained=False):
        super().__init__()
        self.resnet = resnet34_mp(pretrained=not pretrained)
        ...
        if pretrained:
            model_path = "pretrain/aimnet_pretrained_duts.pth"
    ...
    def forward(self, input):
        ...
        glance = F.interpolate(global_sigmoid, size=(h, w), mode="bilinear", align_corners=True)
